...
> This repository contains the complete work for Heart Attack Prediction using the Heart Disease dataset.

The project involves:
>> Exploratory Data Analysis (EDA) on patient health records
>> Data cleaning and preprocessing
>> Building and comparing 7 machine learning models
>> Identifying the best performing model for heart attack prediction
...
4.Support Vector Machine (SVM) ← Best
5. Random Forest
6. K-Nearest Neighbours (KNN)
7. XGBoost

> Best Model Accuracy: **91.8% using SVM**
